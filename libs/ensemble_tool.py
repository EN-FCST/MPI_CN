...
def norm_ensemble(date, num, data_path, period='096'):
    ...
    base = datetime.strptime(date, '%y%m%d%H') # <------------- The starting date of your files
    date_list = [base - relativedelta(days=x) for x in range(num)] # <-- how many days you want
...
def get_weighted_ensemble(cmpt1, W1, cmpt2, W2, cmpt3, W3):
    '''
    Get ensemble results from obj analysis and TS
    '''
